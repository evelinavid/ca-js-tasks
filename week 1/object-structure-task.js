...
{
  const result = obj.f[0].a[0] + obj.y + obj.f[0].a[3] + obj.y + obj.e.a[0].a + obj.y + obj.f[1].a.u + obj.c[1].t;
  console.log(result);
}
console.groupEnd();
...
{
  const result = obj.e.a[0].v + obj.y + obj.f[0].a[1] + obj.y + obj.a.g + obj.y + obj.e.a[0].p + obj.f[1].a.o;
  console.log(result);
}
console.groupEnd();